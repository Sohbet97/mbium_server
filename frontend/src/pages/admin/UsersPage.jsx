...
function UserModal({ open, user, roles, onClose, onSaved }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg dark:bg-black">
        <DialogHeader>
          <DialogTitle className='dark:text-white'>{user ? t('users.editUser') : t('users.createUser')}</DialogTitle>
        </DialogHeader>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5 dark:text-[#a0a0ab]">{t('users.totalCount', { count: total })}</p>
        </div>
            ...
            <table className="w-full text-left">
              ...
              <tbody>
                {loading && users.length === 0 ? (
                  ...
                  return (
                    <tr key={u.id} className="border-b last:border-0 hover:bg-slate-50 dark:hover:bg-white/[0.08] transition-colors">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="text-xs text-slate-400 truncate dark:text-[#a0a0ab]">{u.email || '—'}</p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3 text-xs text-slate-700 dark:text-white/[0.8]">
                        {u.last_login_date
